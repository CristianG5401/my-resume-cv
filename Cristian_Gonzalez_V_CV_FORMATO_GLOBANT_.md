...
components made in angular.js to React.js:

- **Web UI Management:** Reusable UI components for React applications
- **Web Action Areas:** Image Learning \- Language and Literacy Action Areas
  reporting tool.
- **Live Teaching Portal:** New React Frontend Portal for the Live Teaching service.
- **Caliper Event Emitter:** Typescript library for emitting caliper events
  from the Imagine Math frontends.
- **Activity Report React Components:** A React/Typescript component library
  for the live Activity Report dashboard, the library also reaches an API
  using graphql.
- **Apangea:** Apangea allows educators and students to access different
  learning resources and reports. It is a Rails application with a postgres
  database. It contects to other services to give an end to end math
...
the following requirements Accessibility, Responsiveness (mobile first),
Security, Analytics, Internationalization and localization and SEO
optimization. I made several components in Angular, but due to the pandemic
...
- New functionality to delete a report file on OSS, this includes a new method
  on the reports service sdk a new endpoint on reports service project and a
  new rule on the APEGEE proxy.
...
**Visitas Calidad:** Web application to create, implement and manage surveys in
different sectors of the hospital to verify the quality of services. RIOT.js \-
D3.js \- HTML – LESS \- Yii 2  
**Essap:** Web application that records the inputs and outputs of visitors to
the hospital. RIOT.js \- D3.js \- HTML \- LESS \- Yii 2  
**Akamic:** Schools can use this Web application to maintain transcripts,
health records, attendance, demographic information, scheduling, gradebooks,
and custom reports. Vue.js \- D3.js \- HTML \- LESS \- Yii2
...
[cib-interactivo]: http://cib.org.co/interactivo/?test2%23%20
...
through the course of the day and these are displayed in a timeline created in
d3.js, svg and updated in real time with websockets with stomp.js.

- Demo Timeline:
  [http://bl.ocks.org/CristianG540/5631628/ d3.js – svg][demo-timeline]

[demo-timeline]: http://bl.ocks.org/CristianG540/5631628/%20d3.js%20–%20svg
